...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'StudyMate'),
    ...
    */
    'routes' => [
        'prefix' => env('CHATIFY_ROUTES_PREFIX', 'berichten'),
    ...
    'api_routes' => [
        ...
        'namespace' => env('CHATIFY_API_ROUTES_NAMESPACE', 'App\Http\Controllers\vender\Chatify\Api'),
    ],
