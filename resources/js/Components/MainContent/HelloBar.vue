<template>
  <div class="flex flex-col md:flex-row gap-10 justify-between items-center">
    ...
    <div class="flex justify-between gap-2 items-center">
      ...
      <a href="#" class="bg-indigo-500 border border-solid border-indigo-500 py-2 px-4 text-gray-300 rounded-lg hover:border
      hover:bg-stone-50 hover:border-solid hover:border-indigo-500 hover:text-indigo-500">Voeg een taak toe</a>
    </div>
  </div>
</template>
