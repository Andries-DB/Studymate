  ...
  <div class="app-modal" data-name="delete">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="delete" data-modal='0'>
              <div class="app-modal-header">Ben je zeker dat je dit wilt verwijderen?</div>
              <div class="app-modal-body">Deze actie is niet omkeerbaar</div>
              <div class="app-modal-footer">
                  <a href="javascript:void(0)" class="app-btn cancel">Terug</a>
                  <a href="javascript:void(0)" class="app-btn a-btn-danger delete">Verwijder</a>
              </div>
          </div>
      </div>
  </div>
